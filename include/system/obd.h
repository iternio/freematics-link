    ...
    namespace obd {
        ...
        */
        ...
        inline const PID PID_LIST_CHEVROLET_BOLT[] = {
            ...
            {0x22, 0x2885,  0x7E1,  "voltage",          "V",         "{us:1:2}"},
            {0x22, 0x2414,  0x7E1,  "current",          "A",         "{s:1:2}/20.0"},
            {0x22, 0x436B,  0x7E1,  "charge_voltage",   "V",         "{us:1:2}"},
            {0x22, 0x436C,  0x7E1,  "charge_current",   "A",         "{s:1:2}/20.0"},
